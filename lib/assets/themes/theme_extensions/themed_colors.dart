...
class ThemedColors extends ThemeExtension<ThemedColors> {
  ...
  ThemeExtension<ThemedColors> copyWith(
      ...
      ThemedColors(
          ...
          seashellToCinnabar15:
              seashellToCinnabar15 ?? this.seashellToCinnabar15,
          ...
          silver50ToNightRider:
              silver50ToNightRider ?? this.silver50ToNightRider,
  ...
  ThemeExtension<ThemedColors> lerp(
    ...
    return ThemedColors(
      ...
      greyToCinnabar:
          Color.lerp(greyToCinnabar, other.greyToCinnabar, t) ?? greyToCinnabar,
      dividerColorToGrey:
      ...
      ghostToEclipse:
          Color.lerp(ghostToEclipse, other.ghostToEclipse, t) ?? ghostToEclipse,
      ...
      prussianBlueToWhite80:
          Color.lerp(prussianBlueToWhite80, other.prussianBlueToWhite80, t) ??
              prussianBlueToWhite80,
      blackToWhite80:
          Color.lerp(blackToWhite80, other.blackToWhite80, t) ?? blackToWhite80,
      solitudeToCharcoal:
      ...
      solitudeToDarkGray95:
          Color.lerp(solitudeToDarkGray95, other.solitudeToDarkGray95, t) ??
              solitudeToDarkGray95,
      greySuitToWhite60:
          Color.lerp(greySuitToWhite60, other.greySuitToWhite60, t) ??
              greySuitToWhite60,
      whiteToWhite8:
          Color.lerp(whiteToWhite8, other.whiteToWhite8, t) ?? whiteToWhite8,
      solitudeToDolphin8:
          Color.lerp(solitudeToDolphin8, other.solitudeToDolphin8, t) ??
              solitudeToDolphin8,
      dolphinToGreySuit:
          Color.lerp(dolphinToGreySuit, other.dolphinToGreySuit, t) ??
              dolphinToGreySuit,
      darkToWhite: Color.lerp(darkToWhite, other.darkToWhite, t) ?? darkToWhite,
      dividerColorToWhiteOpacity: Color.lerp(dividerColorToWhiteOpacity,
              other.dividerColorToWhiteOpacity, t) ??
          dividerColorToWhiteOpacity,
      ...
      stormGrey12ToStormGrey24: Color.lerp(
          ...
          stormGrey12ToStormGrey24,
      solitudeToDarkRider:
          Color.lerp(solitudeToDarkRider, other.solitudeToDarkRider, t) ??
              solitudeToDarkRider,
      ...
      transparentToNightRider: Color.lerp(
          ...
          transparentToNightRider,
      whiteSmokeToDark:
          Color.lerp(whiteSmokeToDark, other.whiteSmokeToDark, t) ??
              whiteSmokeToDark,
      aluminumToDolphin:
          Color.lerp(aluminumToDolphin, other.aluminumToDolphin, t) ??
              aluminumToDolphin,
      ...
      solitudeToBastille:
          Color.lerp(solitudeToBastille, other.solitudeToBastille, t) ??
              solitudeToBastille,
      whiteToDolphin:
          Color.lerp(whiteToDolphin, other.whiteToDolphin, t) ?? whiteToDolphin,
      mediumSlateBlueToWhite:
          Color.lerp(mediumSlateBlueToWhite, other.mediumSlateBlueToWhite, t) ??
              mediumSlateBlueToWhite,
      lightSlateBlue12ToLightSlateBlue: Color.lerp(
              lightSlateBlue12ToLightSlateBlue,
              other.lightSlateBlue12ToLightSlateBlue,
              t) ??
          lightSlateBlue12ToLightSlateBlue,
      solitudeToGondola:
          Color.lerp(solitudeToGondola, other.solitudeToGondola, t) ??
              solitudeToGondola,
      whiteToSecondNero:
      ...
      lavenderToMediumSlateBlue30: Color.lerp(lavenderToMediumSlateBlue30,
          ...
          lavenderToMediumSlateBlue30,
      snowToNightRider:
          Color.lerp(snowToNightRider, other.snowToNightRider, t) ??
              snowToNightRider,
      solitudeBorderToSolitudeBorder10: Color.lerp(
              solitudeBorderToSolitudeBorder10,
              other.solitudeBorderToSolitudeBorder10,
              t) ??
          solitudeBorderToSolitudeBorder10,
      ...
      veryLightGreyToEclipse:
          Color.lerp(veryLightGreyToEclipse, other.veryLightGreyToEclipse, t) ??
              veryLightGreyToEclipse,
      whiteToGondola:
          Color.lerp(whiteToGondola, other.whiteToGondola, t) ?? whiteToGondola,
      whiteLilacToWhite4:
          Color.lerp(whiteLilacToWhite4, other.whiteLilacToWhite4, t) ??
              whiteLilacToWhite4,
      solitudeToPayneGrey:
          Color.lerp(solitudeToPayneGrey, other.solitudeToPayneGrey, t) ??
              solitudeToPayneGrey,
      ...
      greyContainer26: Color.lerp(greyContainer26, other.greyContainer26, t) ??
          greyContainer26,
      redContainer26:
          Color.lerp(redContainer26, other.redContainer26, t) ?? redContainer26,
      greenContainer26:
          Color.lerp(greenContainer26, other.greenContainer26, t) ??
              greenContainer26,
      ...
      borderGreyToGreen:
          Color.lerp(borderGreyToGreen, other.borderGreyToGreen, t) ??
              borderGreyToGreen,
      whiteToDarkRider:
          Color.lerp(whiteToDarkRider, other.whiteToDarkRider, t) ??
              whiteToDarkRider,
      iconPearlToWhite:
          Color.lerp(iconPearlToWhite, other.iconPearlToWhite, t) ??
              iconPearlToWhite,
      borderGreyToDark:
          Color.lerp(borderGreyToDark, other.darkGreyToWhite, t) ??
              borderGreyToDark,
      whiteToNero1:
          Color.lerp(whiteToNero1, other.whiteToNero1, t) ?? whiteToNero1,
      tangerineYellowToMediumSlateBlue: Color.lerp(
      ...
      fairPinkToIndianTan:
          Color.lerp(fairPinkToIndianTan, other.fairPinkToIndianTan, t) ??
              fairPinkToIndianTan,
    );
  }
}
