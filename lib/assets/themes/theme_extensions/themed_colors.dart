...
class ThemedColors extends ThemeExtension<ThemedColors> {
  ...
  ThemeExtension<ThemedColors> copyWith({
    ...
    Color? ghostToGondola,
      ...
      ThemedColors(
          ...
          mediumSlateBlueToWhite: mediumSlateBlueToWhite ??
              this.mediumSlateBlueToWhite,
          ...
          whiteLilacToWhiteLilac10: whiteLilacToWhiteLilac10 ??
              this.whiteLilacToWhiteLilac10,
          ...
          dividerColorToWhiteOpacity: dividerColorToWhiteOpacity ??
              this.dividerColorToWhiteOpacity,
          solitudeToNero: solitudeToNero ?? this.solitudeToNero,
          ghostToEclipse: ghostToEclipse ?? this.ghostToEclipse,
          cinnabar12ToCinnabar: cinnabar12ToCinnabar ??
              this.cinnabar12ToCinnabar,
  ...
  @override
  ThemeExtension<ThemedColors> lerp(ThemeExtension<ThemedColors>? other,
      double t) {
    ...
    return ThemedColors(
        ...
        Color.lerp(cinnabar12ToCinnabar, other.cinnabar12ToCinnabar, t) ??
            cinnabar12ToCinnabar,
        dolphinToWhite60:
        ...
        solitudeToEclipse: Color.lerp(
            solitudeToEclipse, other.solitudeToEclipse, t) ??
            solitudeToEclipse,
        ...
        Color.lerp(dodgerBlueToWhite80, other.dodgerBlueToWhite80, t) ??
            dodgerBlueToWhite80,
        solitudeToDarkGray95: Color.lerp(
            solitudeToDarkGray95, other.solitudeToDarkGray95, t) ??
            solitudeToDarkGray95,
        greySuitToWhite60: Color.lerp(
            greySuitToWhite60, other.greySuitToWhite60, t) ?? greySuitToWhite60,
        whiteToWhite8: Color.lerp(whiteToWhite8, other.whiteToWhite8, t) ??
            whiteToWhite8,
        solitudeToDolphin8: Color.lerp(
            solitudeToDolphin8, other.solitudeToDolphin8, t) ??
            solitudeToDolphin8,
        dolphinToGreySuit: Color.lerp(
            dolphinToGreySuit, other.dolphinToGreySuit, t) ?? dolphinToGreySuit,
        darkToWhite: Color.lerp(darkToWhite, other.darkToWhite, t) ??
            darkToWhite,
        dividerColorToWhiteOpacity: Color.lerp(
            dividerColorToWhiteOpacity, other.dividerColorToWhiteOpacity, t) ??
            dividerColorToWhiteOpacity,
        whiteLilacToWhiteLilac10: Color.lerp(
            whiteLilacToWhiteLilac10, other.whiteLilacToWhiteLilac10, t) ??
            whiteLilacToWhiteLilac10,
        stormGrey12ToStormGrey24: Color.lerp(
            stormGrey12ToStormGrey24, other.stormGrey12ToStormGrey24, t) ??
            stormGrey12ToStormGrey24,
        solitudeToDarkRider: Color.lerp(
            solitudeToDarkRider, other.solitudeToDarkRider, t) ??
            solitudeToDarkRider,
        stormGrey16ToStormGrey32: Color.lerp(
            stormGrey16ToStormGrey32, other.stormGrey16ToStormGrey32, t) ??
            stormGrey16ToStormGrey32,
        snowToNero: Color.lerp(snowToNero, other.snowToNero, t) ?? snowToNero,
        transparentToNightRider: Color.lerp(
            transparentToNightRider, other.transparentToNightRider, t) ??
            transparentToNightRider,
        whiteSmokeToDark: Color.lerp(
            whiteSmokeToDark, other.whiteSmokeToDark, t) ?? whiteSmokeToDark,
        aluminumToDolphin: Color.lerp(
            aluminumToDolphin, other.aluminumToDolphin, t) ?? aluminumToDolphin,
        lavenderToUltramarine30: Color.lerp(
            lavenderToUltramarine30, other.lavenderToUltramarine30, t) ??
            lavenderToUltramarine30,
        mediumSlateBlue50ToNightRider: Color.lerp(
            mediumSlateBlue50ToNightRider, other.mediumSlateBlue50ToNightRider,
            t) ?? mediumSlateBlue50ToNightRider,
        solitudeToWhite35: Color.lerp(
            solitudeToWhite35, other.solitudeToWhite35, t) ?? solitudeToWhite35,
        transparentToSolitude12: Color.lerp(
            transparentToSolitude12, other.transparentToSolitude12, t) ??
            transparentToSolitude12,
        solitudeToBastille: Color.lerp(
            solitudeToBastille, other.solitudeToBastille, t) ??
            solitudeToBastille,
        whiteToDolphin: Color.lerp(whiteToDolphin, other.whiteToDolphin, t) ??
            whiteToDolphin,
        mediumSlateBlueToWhite: Color.lerp(
            mediumSlateBlueToWhite, other.mediumSlateBlueToWhite, t) ??
            mediumSlateBlueToWhite,
        lightSlateBlue12ToLightSlateBlue: Color.lerp(
            lightSlateBlue12ToLightSlateBlue,
            other.lightSlateBlue12ToLightSlateBlue, t) ??
            lightSlateBlue12ToLightSlateBlue,
        solitudeToGondola: Color.lerp(
            solitudeToGondola, other.solitudeToGondola, t) ?? solitudeToGondola,
        whiteToSecondNero: Color.lerp(
            whiteToSecondNero, other.whiteToSecondNero, t) ?? whiteToSecondNero,
        whiteSmokeToEclipse: Color.lerp(
            whiteSmokeToEclipse, other.whiteSmokeToEclipse, t) ??
            whiteSmokeToEclipse,
        lavenderToMediumSlateBlue30: Color.lerp(
            lavenderToMediumSlateBlue30, other.lavenderToMediumSlateBlue30,
            t) ?? lavenderToMediumSlateBlue30,
        snowToNightRider: Color.lerp(
            snowToNightRider, other.snowToNightRider, t) ?? snowToNightRider,
        solitudeBorderToSolitudeBorder10: Color.lerp(
            solitudeBorderToSolitudeBorder10,
            other.solitudeBorderToSolitudeBorder10, t) ??
            solitudeBorderToSolitudeBorder10,
        solitudeContainerToDark: Color.lerp(
            solitudeContainerToDark, other.solitudeContainerToDark, t) ??
            solitudeContainerToDark,
        dividerColorToGrey: Color.lerp(
            dividerColorToGrey, other.dividerColorToGrey, t) ??
            dividerColorToGrey,
        ghostWhiteToUltramarine10: Color.lerp(
            ghostWhiteToUltramarine10, other.ghostWhiteToUltramarine10, t) ??
            ghostWhiteToUltramarine10,
        midnightExpressToDolphin: Color.lerp(
            midnightExpressToDolphin, other.midnightExpressToDolphin, t) ??
            midnightExpressToDolphin,
        veryLightGreyToEclipse: Color.lerp(
            veryLightGreyToEclipse, other.veryLightGreyToEclipse, t) ??
            veryLightGreyToEclipse,
        whiteToGondola: Color.lerp(whiteToGondola, other.whiteToGondola, t) ??
            whiteToGondola,
        whiteLilacToWhite4: Color.lerp(
            whiteLilacToWhite4, other.whiteLilacToWhite4, t) ??
            whiteLilacToWhite4,
        solitudeToPayneGrey: Color.lerp(
            solitudeToPayneGrey, other.solitudeToPayneGrey, t) ??
            solitudeToPayneGrey,
        ...
        greyContainer26: Color.lerp(
            greyContainer26, other.greyContainer26, t) ??
            greyContainer26,
        redContainer26: Color.lerp(redContainer26, other.redContainer26, t) ??
            redContainer26,
        greenContainer26: Color.lerp(
            greenContainer26, other.greenContainer26, t) ??
            greenContainer26,
        blueContainer26: Color.lerp(
            blueContainer26, other.blueContainer26, t) ??
            blueContainer26,
        darkToPurple:
        Color.lerp(darkToPurple, other.darkToPurple, t) ?? darkToPurple,
        greyToDarkRider: Color.lerp(
            greyToDarkRider, other.greyToDarkRider, t) ??
            greyToDarkRider,
        lightGreenToDarkGreen:
        ...
        Color.lerp(borderGreyToGreen, other.borderGreyToGreen, t) ??
            borderGreyToGreen,
        whiteToDarkRider: Color.lerp(
            whiteToDarkRider, other.whiteToDarkRider, t) ??
            whiteToDarkRider,
        iconPearlToWhite:
      ...
      tangerineYellowToMediumSlateBlue: Color.lerp(tangerineYellowToMediumSlateBlue, other.tangerineYellowToMediumSlateBlue, t) ?? tangerineYellowToMediumSlateBlue,
      ghostToGondola: Color.lerp(ghostToGondola, other.ghostToGondola, t) ?? ghostToGondola,
      whiteSmoke78ToWhiteSmoke12: Color.lerp(whiteSmoke78ToWhiteSmoke12, other.whiteSmoke78ToWhiteSmoke12, t) ?? whiteSmoke78ToWhiteSmoke12,
      whiteSmoke2ToNightRider: Color.lerp(whiteSmoke2ToNightRider, other.whiteSmoke2ToNightRider, t) ?? whiteSmoke2ToNightRider,
