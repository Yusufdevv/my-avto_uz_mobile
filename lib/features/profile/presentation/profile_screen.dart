...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  @override
  Widget build(BuildContext context) => BlocListener<WishlistAddBloc, WishlistAddState>(
    listener: (context, stateWish) {
      if (stateWish.addStatus.isSubmissionSuccess) {
        context.read<ProfileBloc>().add(ChangeCountDataEvent(adding: true));
      }
      if (stateWish.removeStatus.isSubmissionSuccess) {
        context.read<ProfileBloc>().add(ChangeCountDataEvent(adding: false));
      }
    },
