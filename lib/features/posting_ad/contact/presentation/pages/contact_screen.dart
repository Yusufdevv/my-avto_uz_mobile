  ...
  Widget build(BuildContext context) => KeyboardDismisser(
    child: Scaffold(
          body: Form(
            key: _formKey,
            child: BaseWidget(
              onTap: nameController.text.isNotEmpty || emailController.text.isNotEmpty || numberController.text.length > 7?
                widget.onTap: (){},
              child: Column(
                children: [
                  Expanded(
                          ...
                          suffix:                              GestureDetector(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  color: (numberController.text.length == 12) ?orange : Theme.of(context)
                                      .extension<ThemedColors>()!
                                      .veryLightGreyToEclipse ,
                                  borderRadius: BorderRadius.circular(8)
                              ),
                              child: Center(
                                child: Text('Подтвердить', style: Theme.of(context)
                                    .textTheme
                                    .subtitle1!
