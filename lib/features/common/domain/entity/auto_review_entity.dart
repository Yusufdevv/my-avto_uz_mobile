...
class AutoReviewEntity extends Equatable {
  const AutoReviewEntity({
    this.id = -1,
...
class AutoReviewConverter
    implements JsonConverter<AutoReviewEntity, Map<String, dynamic>?> {
  const AutoReviewConverter();
  @override
  AutoReviewEntity fromJson(Map<String, dynamic>? json) =>
      AutoReviewModel.fromJson(json ?? {});

  @override
  Map<String, dynamic>? toJson(AutoReviewEntity object) => AutoReviewModel(
        id: object.id,
