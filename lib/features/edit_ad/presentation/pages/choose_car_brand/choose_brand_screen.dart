...
import 'package:auto/features/edit_ad/presentation/bloc/bloc/choose_make_anime_bloc.dart';
...
class ChooseCarBrand extends StatefulWidget {
  ...
  final EditAdBloc postingAddBloc;
      ...
      if (!BlocProvider.of<ChooseMakeAnimeBloc>(context, listen: false)
        ...
        context
          ...
          widget.postingAddBloc
              .add(EditAdChangeAppBarShadowEvent(value: false));
        });
      }
    } else {
      if (!BlocProvider.of<ChooseMakeAnimeBloc>(context, listen: false)
        ...
        widget.postingAddBloc
            .add(EditAdChangeAppBarShadowEvent(value: true));
        context
            .read<ChooseMakeAnimeBloc>()
            .state
            .animationController
                        ...
                        child: AnimatedContainer(
                          ...
                          child: WTextField(
                            ...
                            onChanged: (value) => widget.postingAddBloc
                                .add(EditAdSearchMakesEvent(name: value)),
                            borderRadius: 12,
                            borderColor: purple,
                            hasSearch: true,
                            ...
                            onClear: () {
                              context
                                  .read<EditAdBloc>()
                                  .add(EditAdSerchControllerClearEvent());
                            },
                          ),
                        ),
                      ),
                  ...
                  child: state.getMakesStatus ==
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            selectedId:
                            context.watch<EditAdBloc>().state.make?.id ??
                                -1,
