...
class AdditionalServicesItem extends StatefulWidget {
 ...
 final AdditionalServicesBloc additionalServicesBloc;
  const AdditionalServicesItem({required this.additionalServicesBloc,Key? key}) : super(key: key);
...
class _AdditionalServicesItemState extends State<AdditionalServicesItem> {
  ...
  @override
  Widget build(BuildContext context) => BlocBuilder<AdditionalServicesBloc, AdditionalServicesState>(
