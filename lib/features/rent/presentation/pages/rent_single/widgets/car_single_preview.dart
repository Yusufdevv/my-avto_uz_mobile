...
class CarSinglePreview extends StatelessWidget {
  ...
  const CarSinglePreview({required this.singleCarsEntity, this.hasCarInfo = true, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      children: [
        ImageViewer(images: singleCarsEntity.images),
        const SizedBox(
          height: 12,
        ),
        Padding(
        ...
        Padding(
          ...
          child: Row(
            children: [
              Text(
                '${MyFunctions.getFormatCost(singleCarsEntity.price)} UZS',
                style: Theme.of(context)
                    .textTheme
                    .headline3!
       ...
       if (hasCarInfo) SingleCarInfoItem(singleCarsEntity: singleCarsEntity) else const SizedBox(),
      ],
    ),
  );
}
