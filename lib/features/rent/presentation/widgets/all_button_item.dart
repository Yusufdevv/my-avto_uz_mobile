...
class AllButtonItem extends StatelessWidget {
  ...
  const AllButtonItem({required this.onTap, required this.title, Key? key}) : super(key: key);
    ...
    child: Row(
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Row(
            children: [
              Text(LocaleKeys.all.tr(), style: Theme.of(context).textTheme.bodyText1!.copyWith(fontSize: 14, color: greyText),),
