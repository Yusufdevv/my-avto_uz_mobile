...
class _NumberItemsState extends State<NumberItems> {
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      child: Text(widget.number, style: isSelected ?  Theme.of(context).textTheme.headline6!.copyWith(color: greyText) : Theme.of(context).textTheme.headline6!.copyWith(color: warmerGrey),),
    ),
  );
}
