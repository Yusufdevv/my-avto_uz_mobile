...
class MapOrganizationEvent with _$MapOrganizationEvent {
  ...
  factory MapOrganizationEvent.getDirectoriesPoints({double? latitude,
    double? longitude,
  ...
  factory MapOrganizationEvent.getCurrentLocation({required ValueChanged<String> onError,
    required ValueChanged<Position> onSuccess}) = _GetCurrentLocation;

  factory MapOrganizationEvent.changeLatLong({required double lat,
    required double long,
    int? radius}) = _ChangeLatLong;

  factory MapOrganizationEvent.getAddressOfDealler({required double lat,
    required double long,
