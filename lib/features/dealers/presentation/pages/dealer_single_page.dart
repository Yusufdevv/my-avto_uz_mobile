...
class _DealerSinglePageState extends State<DealerSinglePage> {
  ...
  @override
  void initState() {
    dealerSingleBloc = DealerSingleBloc()..add(DealerSingleEvent.getResults(slug: widget.slug));
    marksBloc = MarksInDealersBloc(
        marksInDealerUseCase: MarksInDealerUseCase(
            marks: MarksInDealerRepositoryImpl(dataSource: MarksInDealerDataSource(DioSettings().dio))))
      ..add(MarksInDealersEvent.getResults(slug: widget.slug));
    carsBloc = CarsInDealerBloc(
        carsInDealerUseCase: CarsInDealerUseCase(
            cars: CarsInDealerRepositoryImpl(dataSource: CarsInDealerDataSource(DioSettings().dio))))
                      ...
                      child: Column(
                        ...
                        children: [
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      Text(
                                                        LocaleKeys.all.tr(),
                                                        style: const TextStyle(
                                                            fontSize: 14, fontWeight: FontWeight.w400, color: greyText),
                                                      ),
                                                      const SizedBox(
                                                        width: 4,
                                                      ),
                                          ...
                                          Padding(
                                            ...
                                            child: SizedBox(
                                                ...
                                                child: Paginator(
                                                  ...
                                                  paginatorStatus: allMarksState.status,
                                                      ...
                                                      Navigator.push(
                                                        ...
                                                        fade(
                                                          page: SingleMarkAnnouncements(
                                                            ...
                                                            markSlug: allMarksState.marks[index].make.slug,
                                                            carMark: allMarksState.marks[index].make.name,
                                                          ),
                                                        ),
                                                      );
                                                    },
                                                    child: MarksWithAnnouncements(
                                                      quantity: allMarksState.marks[index].carsCount,
                                                      imageUrl: allMarksState.marks[index].make.logo,
                                                      mark: allMarksState.marks[index].make.name,
                                                    ),
                                                  ),
                                                  itemCount: allMarksState.marks.length,
                                                  fetchMoreFunction: () {
                                                    marksBloc
                                                        .add(MarksInDealersEvent.getMoreResults(slug: widget.slug));
                                                  },
                                                  hasMoreToFetch: allMarksState.moreFetch ?? false,
                          ...
                          BlocBuilder<CarsInDealerBloc, CarsInDealerState>(
                              builder: (context, allCarsState) => allCarsState.status.isSubmissionSuccess
                                  ? Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        if (allCarsState.cars.length > 9)
                                          Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Expanded(
                                                    child: Text(LocaleKeys.cars.tr(args: [dealer.name]),
                                                  ...
                                                  onTap: () => Navigator.push(
                                                    ...
                                                    fade(
                                                      page: BlocProvider(
                                                        ...
                                                        child: AllCarsInDealerScreen(slug: widget.slug),
                                                      ),
                                                    ),
                                                  ),
                                                  behavior: HitTestBehavior.opaque,
                                        ...
                                        if (allCarsState.cars.isNotEmpty)
                                          Padding(
                                            ...
                                            child: SizedBox(
                                              height: 293,
                                              child: Paginator(
                                                hasMoreToFetch: allCarsState.moreFetch ?? false,
                                                fetchMoreFunction: () {
                                                  carsBloc.add(CarsInDealerEvent.getMoreResults(slug: widget.slug));
                                                },
                                                ...
                                                itemBuilder: (context, index) =>
                                                  ...
                                                  listener: (context, stateWish) {
                                                    if (stateWish.addStatus.isSubmissionSuccess ||
                                                      ...
                                                      if (stateWish.id == allCarsState.cars[index].id) {
                                                        context.read<CarsInDealerBloc>().add(
                                                            CarsInDealerEvent.changeIsWish(
                                                  ...
                                                  builder: (context, stateWishBuild) => AdsItem(
                                                    ...
                                                    image: allCarsState.cars[index].gallery.isNotEmpty
                                                        ? allCarsState.cars[index].gallery.first
                                                        : '',
                                                    name: allCarsState.cars[index].absoluteCarName,
                                                    currency: allCarsState.cars[index].currency,
                                                    description: allCarsState.cars[index].description,
                                                    isLiked: allCarsState.cars[index].isWishlisted,
                                                    location: allCarsState.cars[index].region.title,
                                                    onTapLike: () {
                                                      context.read<WishlistAddBloc>().add(
                                                          allCarsState.cars[index].isWishlisted
                                                              ? WishlistAddEvent.removeWishlist(
                                                                  allCarsState.cars[index].id, index)
