                  ...
                  ...List.generate(
                    ...
                    (index) => Padding(
                      ...
                      child: InfoContainer(
                        ...
                        owner: carsInMarksState.cars[index].absoluteCarName,
                        ...
                        sellType: '',
                        hasStatusInfo: carsInMarksState.cars[index].isNew,
                        gallery: carsInMarksState.cars[index].gallery,
                        currency: carsInMarksState.cars[index].currency,
                        initialLike: carsInMarksState.cars[index].isWishlisted,
                        onTapFavorites: () {},
                        onTapComparsion: () {},
                        initialComparsions: carsInMarksState.cars[index].isComparison,
                        id: carsInMarksState.cars[index].id,
                      ),
                    ),
                  ),
                ],
