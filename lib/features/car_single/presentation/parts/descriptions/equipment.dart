...
class _EquipmentCardState extends State<EquipmentCard> {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        Text('Комплектация CLS 400 4MATIC', style: Theme.of(context).textTheme.headline1!.copyWith(fontSize: 18),),
        const SizedBox(height: 12,),
        ...List.generate(entity.length, (index) => EquipmentTile(equipmentEntity: entity[index]),),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text('Показать все', style: Theme.of(context).textTheme.headline3!.copyWith(fontSize: 14, fontWeight: FontWeight.w600),),
