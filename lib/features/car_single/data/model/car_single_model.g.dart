...
CarSingleModel _$CarSingleModelFromJson(Map<String, dynamic> json) => CarSingleModel(
      id: json['id'] as int? ?? 0,
      make: json['make'] == null
          ? const RentCarMakeEntity()
          : const RentCarMakeConverter().fromJson(json['make'] as Map<String, dynamic>?),
      model: json['model'] == null
          ? const RentCarModelsEntity()
          : const RentCarModelsConverter().fromJson(json['model'] as Map<String, dynamic>?),
      ...
      generation: json['generation'] == null
          ...
          : const RentCarGenerationConverter().fromJson(json['generation'] as Map<String, dynamic>?),
      bodyType: json['body_type'] == null
          ? const RentCarBodyTypeEntity()
          : const RentCarBodyTypeConverter().fromJson(json['body_type'] as Map<String, dynamic>?),
      driveType: json['drive_type'] == null
          ? const RentCarDriveTypeEntity()
          : const RentCarDriveTypeConverter().fromJson(json['drive_type'] as Map<String, dynamic>?),
      engineType: json['engine_type'] == null
          ? const RentCarEngineTypeEntity()
          : const RentCarEngineTypeConverter().fromJson(json['engine_type'] as Map<String, dynamic>?),
      gearboxType: json['gearbox_type'] == null
          ? const RentCarGearboxTypeEntity()
          : const RentCarGearboxTypeConverter().fromJson(json['gearbox_type'] as Map<String, dynamic>?),
      modificationType: json['modification_type'] == null
          ? const RentCarModificationEntity()
          : const RentCarModificationConverter().fromJson(json['modification_type'] as Map<String, dynamic>?),
      ...
      registrationSerialNumber: json['registration_serial_number'] as String? ?? '',
      registeredInUzbekistan: json['registered_in_uzbekistan'] as bool? ?? false,
      user: json['user'] == null
          ? const CarUserEntity()
          : const CarUserConverter().fromJson(json['user'] as Map<String, dynamic>?),
      ...
      damagedParts: (json['damaged_parts'] as List<dynamic>?)
              ?.map((e) => const DamagedPartsConverter().fromJson(e as Map<String, dynamic>?))
              .toList() ??
          const [],
    );

Map<String, dynamic> _$CarSingleModelToJson(CarSingleModel instance) => <String, dynamic>{
      'id': instance.id,
      ...
      'generation': const RentCarGenerationConverter().toJson(instance.generation),
      'body_type': const RentCarBodyTypeConverter().toJson(instance.bodyType),
      'drive_type': const RentCarDriveTypeConverter().toJson(instance.driveType),
      'engine_type': const RentCarEngineTypeConverter().toJson(instance.engineType),
      'gearbox_type': const RentCarGearboxTypeConverter().toJson(instance.gearboxType),
      'modification_type': const RentCarModificationConverter().toJson(instance.modificationType),
      ...
      'damaged_parts': instance.damagedParts.map(const DamagedPartsConverter().toJson).toList(),
    };
