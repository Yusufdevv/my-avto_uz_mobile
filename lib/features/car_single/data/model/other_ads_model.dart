...
class OtherAdsModel extends OtherAdsEntity {
  ...
  factory OtherAdsModel.fromJson(Map<String, dynamic> json) =>
      _$OtherAdsModelFromJson(json);

  Map<String, dynamic> toJson() => _$OtherAdsModelToJson(this);
}

class DistrictConverter
    implements JsonConverter<OtherAdsEntity, Map<String, dynamic>?> {
  const DistrictConverter();

  @override
  OtherAdsEntity fromJson(Map<String, dynamic>? json) =>
      OtherAdsModel.fromJson(json ?? {});
