...
class CarSingleUseCase implements UseCase<CarSingleEntity, NoParams> {
  final CarSingleRepository repository;
  CarSingleUseCase({required this.repository});

  @override
  Future<Either<Failure, CarSingleEntity>> call(NoParams params) async => repository.getCarAds();
}
